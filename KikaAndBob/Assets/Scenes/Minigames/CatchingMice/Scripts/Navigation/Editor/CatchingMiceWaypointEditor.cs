...
[CustomEditor(typeof(CatchingMiceWaypoint))]
[CanEditMultipleObjects]
public class CatchingMiceWaypointEditor : Editor 
{
	protected bool showDefault = true;
	protected bool showData = true; 
	
	protected string message = "";
	protected CatchingMiceWaypoint previousNeighbour = null;  
	
	public override void OnInspectorGUI() 
	{
		CatchingMiceWaypoint subject = (CatchingMiceWaypoint) target;
		...
		*/
		...
		if( showData )
		{
			...
			foreach( CatchingMiceWaypoint neighbour in subject.neighbours )
			{
				if( neighbour == null )
				{
	...
	public void OnSceneGUI() 
	{
       ...
       // style.normal.textColor = Color.red;
		...
		CatchingMiceWaypoint[] allWaypoints = (CatchingMiceWaypoint[]) GameObject.FindObjectsOfType( typeof(CatchingMiceWaypoint) );
		foreach( CatchingMiceWaypoint waypoint in allWaypoints )
		{
