...
public class DinnerDashTutorials_26Belgium : IDinnerDashTutorial 
{
	DinnerDashConfig_26Belgium config = null;
	...
	public override void NextStep()
	{
		...
		if( config == null )
		{
			config = (DinnerDashConfig_26Belgium) IDinnerDashConfig.use;
		}
	...
	- tap sandwich (bob will make more)
		...
		*/
		...
		{
			SingleOrderFull( 2, "e26_belgium.tutorial.1.burger", config.BurgerProducer );
		}
		else if( stepCount < 16 )
		{
			SingleOrderFull( 9, "e26_belgium.tutorial.1.burgerLong", config.BurgerLongProducer );
		}
		else if( stepCount < 24 )
		{
			DoubleOrderFull( 16, "e26_belgium.tutorial.1.doubleOrder", config.BurgerLongProducer, config.BurgerProducer );
		}
	...
	public void Tutorial1_Step()
	{
		...
		{
			SingleProcessorOrderFull( 2, "e26_belgium.tutorial.2.fries" , config.PotatoProducer, config.FryerKetchup );
		} 
	...
	public void Tutorial2_Step()
	{
		...
		{
			SingleProcessorOrderFull( 2, "e26_belgium.tutorial.3.juice", config.OrangeProducer, config.Blender );
		} 
