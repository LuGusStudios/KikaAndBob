...
public class RuntimeConsole : MonoBehaviour {
  ...
  public static bool IsOpen {
    get { return RuntimeConsole.Instance._isOpen; }
    set { RuntimeConsole.Instance._isOpen = value; }
  }
  ...
  static RuntimeConsole Instance {
    get {
      if (_instance == null) {
        _instance = FindObjectOfType(typeof(RuntimeConsole)) as RuntimeConsole;
        ...
        _instance = console.AddComponent<RuntimeConsole>();
      }
  ...
  static RuntimeConsole _instance;
...
#region GUI position values
  ...
  void OnEnable() {
    ...
    _windowRect = new Rect(5.0f, 5.0f, 450.0f, 450.0f);
...
#else
    _windowRect = new Rect(30.0f, 30.0f, 450.0f, 450.0f);
#endif
...
#region StaticAccessors
  ...
  public static object Log(object message) {
    RuntimeConsole.Instance.LogMessage(Message.Log(message));
  ...
  public static object Log(object message, MessageType messageType) {
    RuntimeConsole.Instance.LogMessage(new Message(message, messageType));
  ...
  public static object Log(object message, Color displayColor) {
    RuntimeConsole.Instance.LogMessage(new Message(message, displayColor));
  ...
  public static object Log(object message, MessageType messageType, Color displayColor) {
    RuntimeConsole.Instance.LogMessage(new Message(message, messageType, displayColor));
  ...
  public static object LogWarning(object message) {
    RuntimeConsole.Instance.LogMessage(Message.Warning(message));
  ...
  public static object LogError(object message) {
    RuntimeConsole.Instance.LogMessage(Message.Error(message));
  ...
  public static void Clear() {
    RuntimeConsole.Instance.ClearLog();
  }
  ...
  public static void Execute(string commandString) {
    RuntimeConsole.Instance.EvalInputString(commandString);
  }
  ...
  public static void RegisterCommand(string commandString, DebugCommand commandCallback) {
    RuntimeConsole.Instance.RegisterCommandCallback(commandString, commandCallback);
  }
  ...
  public static void UnRegisterCommand(string commandString) {
    RuntimeConsole.Instance.UnRegisterCommandCallback(commandString);
  }
  ...
  public static void RegisterWatchVar(WatchVarBase watchVar) {
    RuntimeConsole.Instance.AddWatchVarToTable(watchVar);
  }
  ...
  public static void UnRegisterWatchVar(string name) {
    RuntimeConsole.Instance.RemoveWatchVarFromTable(name);
  }
#endregion
...
public abstract class WatchVarBase {
  ...
  public void Register() {
    RuntimeConsole.RegisterWatchVar(this);
  }

  public void UnRegister() {
    RuntimeConsole.UnRegisterWatchVar(Name);
  }
